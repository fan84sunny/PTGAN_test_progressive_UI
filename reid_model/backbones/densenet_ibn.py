...
def densenet121_ibn_a(pretrained=False, **kwargs):
    r"""Densenet-121-IBN-a reid_model from
    `"Densely Connected Convolutional Networks" <https://arxiv.org/pdf/1608.06993.pdf>`_
    Args:
        pretrained (bool): If True, returns a reid_model pre-trained on ImageNet
    """
...
def densenet169_ibn_a(pretrained=False, **kwargs):
    r"""Densenet-169-IBN-a reid_model from
    `"Densely Connected Convolutional Networks" <https://arxiv.org/pdf/1608.06993.pdf>`_
    Args:
        pretrained (bool): If True, returns a reid_model pre-trained on ImageNet
    """
...
def densenet201_ibn_a(pretrained=False, **kwargs):
    r"""Densenet-201-IBN-a reid_model from
    `"Densely Connected Convolutional Networks" <https://arxiv.org/pdf/1608.06993.pdf>`_
    Args:
        pretrained (bool): If True, returns a reid_model pre-trained on ImageNet
    """
    model = DenseNet_IBN(num_init_features=64, growth_rate=32, block_config=(6, 12, 48, 32),
                     **kwargs)
    if pretrained:
        warnings.warn("Pretrained reid_model not available for Densenet-201-IBN-a!")
    return model


def densenet161_ibn_a(pretrained=False, **kwargs):
    r"""Densenet-161-IBN-a reid_model from
    `"Densely Connected Convolutional Networks" <https://arxiv.org/pdf/1608.06993.pdf>`_
    Args:
        pretrained (bool): If True, returns a reid_model pre-trained on ImageNet
    """
    model = DenseNet_IBN(num_init_features=96, growth_rate=48, block_config=(6, 12, 36, 24),
                     **kwargs)
    if pretrained:
        warnings.warn("Pretrained reid_model not available for Densenet-161-IBN-a!")
    return model
...
class DenseNet_IBN(nn.Module):
    r"""Densenet-BC reid_model class, based on
    `"Densely Connected Convolutional Networks" <https://arxiv.org/pdf/1608.06993.pdf>`_
    Args:
