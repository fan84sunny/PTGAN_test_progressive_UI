...
class Backbone(nn.Module):
    def __init__(self, num_classes, cfg):
        ...
        if pretrain_choice == 'imagenet' and model_name != 'efficientnet_b7':
            ...
            print('Loading pretrained ImageNet reid_model......from {}'.format(model_path))
            ...
            print('Loading finetune reid_model......from {}'.format(model_path))
    ...
    def load_param(self, trained_path):
        ...
        print('Loading pretrained reid_model from {}'.format(trained_path))
