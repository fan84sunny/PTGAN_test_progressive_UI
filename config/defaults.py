...
# Path to pretrained reid_model of backbone
_C.MODEL.PRETRAIN_PATH = ''
_C.MODEL.DIST_TRAIN = False
# Use ImageNet pretrained reid_model to initialize backbone or use self trained reid_model to initialize the whole reid_model
...
# Misc options
# ---------------------------------------------------------------------------- #
# Path to checkpoint and saved log of trained reid_model
_C.OUTPUT_DIR = ""
