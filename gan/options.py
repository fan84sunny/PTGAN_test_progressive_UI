...
class Options(object):
    def __init__(self):
        ...
        self.parser.add_argument('--netE_pretrain', type=str,
                                 default='/home/ANYCOLOR2434/AICITY2021_Track2_DMT/AICITY2021_Track2_DMT-main/code_sw/gan/weights/model_130.pth')
        self.parser.add_argument('--netG_pretrain', type=str,
                                 default='/home/ANYCOLOR2434/AICITY2021_Track2_DMT/AICITY2021_Track2_DMT-main/code_sw/weights/GAN_stage_2/17_net_G.pth')
        self.parser.add_argument('--netDp_pretrain', type=str,
                                 default='/home/ANYCOLOR2434/AICITY2021_Track2_DMT/AICITY2021_Track2_DMT-main/code_sw/weights/GAN_stage_2/17_net_Dp.pth')
        self.parser.add_argument('--netDi_pretrain', type=str,
                                 default='/home/ANYCOLOR2434/AICITY2021_Track2_DMT/AICITY2021_Track2_DMT-main/code_sw/weights/GAN_stage_2/17_net_Di.pth')
